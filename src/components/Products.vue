        ...
        <div class="row">
          ...
          <div class="col-sm-4 sm-margin-b-50">
            <div class="margin-b-20">
              <img class="img-responsive wow fadeIn" src="@/assets/img/970x647/01.jpg" alt="Latest Products Image"
          ...
          <div class="col-sm-4 sm-margin-b-50">
            <div class="margin-b-20">
              <img class="img-responsive wow fadeIn" src="@/assets/img/970x647/02.jpg" alt="Latest Products Image"
          ...
          <div class="col-sm-4 sm-margin-b-50">
            <div class="margin-b-20">
              <img class="img-responsive wow fadeIn" src="@/assets/img/970x647/03.jpg" alt="Latest Products Image"
